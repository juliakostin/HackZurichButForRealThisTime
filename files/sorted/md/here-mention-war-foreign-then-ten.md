...
----------
```powershell
PS> ./write-vertical.ps1 [[-text] <String>] [<CommonParameters>]
...
*(generated by convert-ps2md.ps1 using the comment-based help of write-vertical.ps1 as of 09/01/2023 17:51:58)*
