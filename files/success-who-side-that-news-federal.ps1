...
try {
	...
	"â³ (2/4) Checking local repository...             ðŸ“‚$RepoDir"
	...
	"âœ”ï¸ Cleaned repo ðŸ“‚$RepoDirName in $Elapsed sec"
	exit 0 # success
} catch {
